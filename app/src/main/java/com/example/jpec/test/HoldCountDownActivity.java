...
/**
 * Created by jpec on 23/01/17.
 */

public class HoldCountDownActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_holdcountdown);
    ...
    public void start(){
        ...
        countDownTimer = new CountDownTimer((3+currentExo.getNbreps())*1000,1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                pickednumber=currentExo.getNbreps()-(int)(millisUntilFinished/1000); //TODO
                //remainingtime=millisUntilFinished;
                if (millisUntilFinished/1000 <= 1){
                    time.setText(""+millisUntilFinished / 1000);
                    //boolean qui permet de savoir si on a réellement fini ou juste un appel à finish
                    finish=true;
                }
                else {
                    time.setText("" + millisUntilFinished / 1000);
            ...
            public void onFinish() {
                ...
                if (finish){ //INUTILE
                    pickednumber=currentExo.getNbreps();       //A mettre avant pour donner la bonne valeur à pickednumber
